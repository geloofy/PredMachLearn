...
##Model fit
A random forest model will be fitted.
...
We would expect the out of sample error rate to be similar, if not slight higher than this.
...
The accuracy is around 99.5%, giving out out of sample error of around 0.5%.
...
##Conclusion
The random forest model was able to provide a very accurate prediction of classe based on the us of all of the available parameters.